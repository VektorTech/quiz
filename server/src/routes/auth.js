...
const openIDVerify = async function verify(issuer, profile, context, idToken, cb) {
...
passport.use(
  new OpenIDConnectGoogleStrategy(
    openIDOptions,
    openIDVerify
  )
);
...
authRouter.get("/login/google", passport.authenticate("openidconnect-google"));
